...
const buildPremiumUrl = (vin) =>
  `${PROVIDER.urlBase}${encodeURIComponent(vin)}`;
...
const CarHistoryApp = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (!validateFIN(finNumber)) {
      setError(
        "Numri i FIN është i pavlefshëm. Duhet të ketë 17 karaktere (A-Z, 0-9, pa I, O, Q)"
      );
      return;
    }
        ...
        specifications: [
          { label: "Klasa e trupit", value: findValue("Body Class") },
          {
            ...
            value:
              ...
              (findValue("Engine Power (kW)") !== "Nuk ka të dhëna"
                ? " kW"
                : ""),
          },
          {
            label: "Lloji i karburantit",
            value: findValue("Fuel Type - Primary"),
          },
          ...
          {
            label: "Cilindrat e motorit",
            value: findValue("Engine Number of Cylinders"),
          },
          {
            label: "Lloji i transmisionit",
            value: findValue("Transmission Style"),
          },
          ...
          <div className="text-center mb-8">
            <div className="flex justify-center items-center mb-4">
              ...
              <h1 className="text-4xl font-bold text-gray-800">
                Kontrollo Historin e Automjetit
              </h1>
            </div>
            <p className="text-gray-600 text-lg">
              Shkruani numrin e FIN për të marrë historin e plotë të automjetit
            </p>
          </div>
              ...
              {showPremiumOption && results && (
                <div className="mt-4 p-4 bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-lg">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center mb-2">
                        ...
                        <h3 className="font-semibold text-gray-800">
                          Hap Raportin Premium jashtë
                        </h3>
                      </div>
                      <p className="text-sm text-gray-700 mb-3">
                        Historik i detajuar aksidentesh, kilometrazh i
                        verifikuar dhe kontrolle vjedhjeje nga{" "}
                        {PROVIDER.countries}. Raporti hapet në një tab të ri në{" "}
                  ...
                  <p className="mt-2 text-xs text-gray-600">
                    Shënim: Blerja dhe shikimi i raportit ndodhin tërësisht në
                    faqen e ofruesit. Ky aplikacion nuk ruan të dhëna pagese ose
                    raporti.
                  </p>
                </div>
              )}
